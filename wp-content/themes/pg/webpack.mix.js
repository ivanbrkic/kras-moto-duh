...
mix.browserSync({
  ...
  files: [
    `${distributionPath}/**/*`, // Asset files.
    '*.php', // All PHP files in your theme root directory.
    '{lib,templates,components,woocommerce}/**/*.php', // All PHP files in lib, templates, components, woocommerce directories.
  ],
});
