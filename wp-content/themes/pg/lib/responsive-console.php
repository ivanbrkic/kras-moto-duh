...
add_action(
	...
	function() {
		if ( Pg_Assets::asset_exists( '/responsive-console/responsive-console.js' ) ) {
			wp_enqueue_script( 'pg-responsive-console-js', Pg_Assets::get_asset_uri( '/responsive-console/responsive-console.js' ), [ 'jquery' ], Pg_Assets::get_asset_version( '/responsive-console/responsive-console.js' ), true );
		}

		if ( Pg_Assets::asset_exists( '/responsive-console/responsive-console.css' ) ) {
			wp_enqueue_style( 'pg-responsive-console-css', Pg_Assets::get_asset_uri( '/responsive-console/responsive-console.css' ), [], Pg_Assets::get_asset_version( '/responsive-console/responsive-console.css' ) );
		}
	}
);
