...
add_action(
	...
	function() {
		if ( Pg_Assets::asset_exists( '/admin/gutenberg.js' ) ) {
			wp_enqueue_script( 'pg-gutenberg-js', Pg_Assets::get_asset_uri( '/admin/gutenberg.js' ), [ 'wp-blocks', 'wp-dom-ready', 'wp-edit-post' ], Pg_Assets::get_asset_version( '/admin/gutenberg.js' ), true );
		}
	}
);
