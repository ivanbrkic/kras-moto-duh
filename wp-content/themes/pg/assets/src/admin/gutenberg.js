...
wp.domReady(() => {
  ...
  const allowedBlocks = new Set(['core/paragraph', 'core/heading', 'core/list', 'core/list-item', 'core/image', 'core/quote', 'core/gallery', 'core/embed', 'core/video', 'core/audio', 'core/freeform']);
  ...
  const allowedEmbedBlocks = new Set(['twitter', 'vimeo', 'youtube']);
...
wp.hooks.addFilter(
  ...
  (settings, name) => {
    const blocks = new Set(['core/gallery', 'core/video', 'core/audio', 'core/embed']);
