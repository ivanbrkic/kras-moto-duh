...
<div class="pt-10 text-center" id="tjedan3">

	<h2 class="mw-650 mx-auto title-c1">Dobitnici trećeg tjedna</h2>
	<?php

	$win = [
		['Lucija Ristić','Lucija Ristić.jpg'],
		['Ivana Jadrić','Ivana Jadrić.jpg'],
		['Danijel Butković','Danijel Butković.jpg'],
		['Malea Ivancic','Malea Ivancic.jpg'],
		['Mirjana Kauzlaric','Mirjana Kauzlaric.jpg'],
		['Dario Razum','Dario Razum.jpg'],
		['Nina Tomić','Nina Tomić.jpg'],
		['Ivanka Aničić','Ivanka Aničić.jpg'],
		['Nedjeljka Varez','Nedjeljka Varez.jpg'],
		['Josipa Marjanovic','Josipa Marjanovic.jpg'],
		['Lara Lovrek','Lara Lovrek.jpg'],
		['Tihana Koprtla Peulić','Tihana Koprtla Peulić.jpg'],
		['Sara Škrgat','Sara Škrgat.jpg'],
		['Nada Bogdan','Nada Bogdan.jpg'],
		['Stela Perković','Stela Perković.jpg'],
		['Mateja Komljenovic','Mateja Komljenovic.jpg'],
		['Vedrana Klarić Trupčević','Vedrana Klarić Trupčević.jpg'],
		['Valentina Kruljac','Valentina Kruljac.jpg'],
		['Zlatko Matić','Zlatko Matić.jpg'],
		['Nevena Gojkovic','Nevena Gojkovic.jpg'],
		['Marina Mršić','Marina Mršić.jpg'],
		['Marija Dujić','Marija Dujić.jpg'],
		['Melani Mihalić','Melani Mihalić.jpg'],
		['Matea Brnčić','Matea Brnčić.jpg'],
		['Gabriela Jakovović','Gabriela Jakovović.jpg'],
	...
	<div class="swiper js-swiper" style="max-width: 1920px; margin 0 auto;">
		<div class="swiper-wrapper">
			<?php foreach ( $win as $key => $value ) : ?>
			<div class="swiper-slide">
				<img src="/wp-content/themes/pg/assets/static/img/03/<?php echo ( $value[1] ) ?>" />
				<span class="title-2"><b><?php echo $value[0] ?></b></span>
			</div>
			<?php endforeach; ?>
